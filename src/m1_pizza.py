...
def run_test_pizza():
    ...
    # -------------------------------------------------------------------------
    #Test 4:
    window = rg.RoseWindow(400,400, 'Pizza test 4: 200 slices, thin black lines on yellow')
    circle = rg.Circle(rg.Point(210,210), 142)
...
def run_test_polygon():
    ...
    # -------------------------------------------------------------------------
    window = rg.RoseWindow(400,400, 'Polygon test 3: 4 segments, black lines on lime green circle')
    circle = rg.Circle(rg.Point(200,200), 150)
...
def run_test_fancy_polygon():
    ...
    #Test 4
    window = rg.RoseWindow(400,400, 'Fancy Polygon Test 4, draws something cool')
    circle = rg.Circle(rg.Point(200,200), 150)
    circle.fill_color = 'lime green'
    fancy_polygon(window, circle, 200, 60, 'black', 1)
    window.close_on_mouse_click()
